...
/**
 *
 * This script sends an email to me, adi.
 * This is merely to determine if SMTP mailing is working on the server
 *
 **/
...
$from_name = 'The Living Wallers';

$to_emails = [ 'adityabhat@lazaro.in' ];
$to_emails_CC = [ ];

$subject = '( no subject )';
$message = 'hey, how it walls?!';
