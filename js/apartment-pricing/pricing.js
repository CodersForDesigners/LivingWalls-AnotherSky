	...
	function print_list() {
	    	...
	    	for (var i=0; i < concerned_array.length; i++) {
	    		...
	    		if ( concerned_array[i]['apt_blocking'] == '1') {
					$("#listing").append( "<li class='item block clearfix'><span class='i-number'>" + temp_apt_number + "</span>" + "<span class='i-floor'>" + temp_floor + " FLOOR</span>" + "<span class='i-area'>" + concerned_array[i]['apt_area'] + " SFT</span>" + "<span class='i-price'>₹ " + commafy(concerned_array[i]['apt_price']) + "</span>" + "<span class='fl-right'><span class='inline-middle button outline js_view_details js_modal_trigger' data-modal-trigger='content-text' data-view-details='"+temp_apt_number+"'>View Details</span><img class='inline-middle js_add_to_fav' data-view-details='"+temp_apt_number+"' src='media/images/pricing/heart.svg?v=2.1'></span></li>");
	    		} else {
					$("#listing").append( "<li class='item block clearfix'><span class='i-number'>" + temp_apt_number + "</span>" + "<span class='i-floor'>" + temp_floor + " FLOOR</span>" + "<span class='i-area'>" + concerned_array[i]['apt_area'] + " SFT</span>" + "<span class='i-price'>₹ " + commafy(concerned_array[i]['apt_price']) + "</span>" + "<span class='fl-right'><span class='inline-middle button blue-outline js_view_details js_modal_trigger' data-modal-trigger='content-text' data-view-details='"+temp_apt_number+"'>View Details</span><img class='inline-middle js_add_to_fav' data-view-details='"+temp_apt_number+"' src='media/images/pricing/heart.svg?v=2.1'></span></li>");
				}
	    	} // end of for loop
